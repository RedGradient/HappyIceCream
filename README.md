...
Сбой отправки email **не отменяет** регистрацию, повторное подтверждение, сброс пароля, розыгрыш и активацию промокода (ошибка пишется в лог). При тестировании можно "подтвердить" email через админку, поставив соответствующую галочку на странице пользователя.
